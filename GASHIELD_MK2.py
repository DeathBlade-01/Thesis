...
class GeneticAlgorithmScheduler:
    ...
    def simulate_schedule(self, tasks, processors, security_levels):
        ...
        # Ensure processors are properly used here
        ...
        for task in sorted_tasks:
            ...
            est = max(processor.available_time, 0)
...
def main():
    ...
    messages = [
        Message(1, 3, 300),  # From Task1 to Task3
        Message(1, 4, 400),  # From Task1 to Task4
        Message(2, 5, 200),  # From Task2 to Task5
        Message(2, 6, 100),  # From Task2 to Task6
        Message(3, 7, 250),  # From Task3 to Task7
        Message(4, 7, 150),  # From Task4 to Task7
        Message(3, 8, 200),  # From Task3 to Task8
        Message(5, 8, 300),  # From Task5 to Task8
        Message(6, 9, 350),  # From Task6 to Task9
        Message(7, 10, 400), # From Task7 to Task10
        Message(8, 10, 300), # From Task8 to Task10
        Message(9, 10, 250)  # From Task9 to Task10
    ]
