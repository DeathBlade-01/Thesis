    ...
    def calculate_est(self, task, processor):
        ...
        for pred_id in task.predecessors:
            ...
            if pred_task.assigned_processor == processor:
                ...
                # Calculate security overhead for sender
                ...
                # The security overhead is considered part of the sender and receiver task times
        ...
        for task in sorted_tasks:
            ...
            for pred_id in task.predecessors:
                ...
                if pred_task.assigned_processor == processor_id:
                    ...
                    # Calculate actual communication time with security overhead
            ...
            for processor in self.processors:
                ...
                for succ_id in task.successors:
                    ...
                    if succ_task:
                        message = self.get_message(task.task_id, succ_id)
                        if message:
                            # We'll calculate sender overhead assuming cross-processor communication
                            # This may be an overestimate if successors end up on same processor
                            for service in ['confidentiality', 'integrity']:
                                protocol_idx = message.assigned_security[service] + 1
